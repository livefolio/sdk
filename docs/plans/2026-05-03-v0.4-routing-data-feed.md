...
- A streaming counterpart (`RoutingStreamingDataFeed`) — designed separately in `docs/specs/2026-05-03-routing-streaming-and-polling-design.md` with companion plan `docs/plans/2026-05-03-routing-streaming-and-polling.md`. Lands as a follow-up task series, not as part of this plan.
